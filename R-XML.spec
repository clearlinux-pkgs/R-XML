...
Version  : 3.98.1.7
Release  : 30
URL      : https://cran.r-project.org/src/contrib/XML_3.98-1.7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/XML_3.98-1.7.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1496616266
