...
Version  : 3.99.0.17
Release  : 119
URL      : https://cran.r-project.org/src/contrib/XML_3.99-0.17.tar.gz
Source0  : https://cran.r-project.org/src/contrib/XML_3.99-0.17.tar.gz
Summary  : Tools for Parsing and Generating XML Within R and S-Plus
Group    : Development/Tools
License  : BSD-3-Clause GPL-2.0
Requires: R-XML-lib = %{version}-%{release}
Requires: R-XML-license = %{version}-%{release}
...
%package license
Summary: license components for the R-XML package.
Group: Default

%description license
license components for the R-XML package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719332514

%install
export SOURCE_DATE_EPOCH=1719332514
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/R-XML
cp %{_builddir}/XML/inst/COPYRIGHTS %{buildroot}/usr/share/package-licenses/R-XML/3aeeae1861b96417ae80129b2501231da3aa8232 || :
LANG=C.UTF-8
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/XML/libs/XML.so
/V4/usr/lib64/R/library/XML/libs/XML.so
/usr/lib64/R/library/XML/libs/XML.so

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/R-XML/3aeeae1861b96417ae80129b2501231da3aa8232
