...
Version  : 3.98.1.12
Release  : 52
URL      : https://cran.r-project.org/src/contrib/XML_3.98-1.12.tar.gz
Source0  : https://cran.r-project.org/src/contrib/XML_3.98-1.12.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1531756058
