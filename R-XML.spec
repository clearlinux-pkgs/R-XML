...
Version  : 3.98.1.10
Release  : 42
URL      : https://cran.r-project.org/src/contrib/XML_3.98-1.10.tar.gz
Source0  : https://cran.r-project.org/src/contrib/XML_3.98-1.10.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1519057795
