...
Version  : 3.98.1.13
Release  : 53
URL      : https://cran.r-project.org/src/contrib/XML_3.98-1.13.tar.gz
Source0  : https://cran.r-project.org/src/contrib/XML_3.98-1.13.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1533134178
