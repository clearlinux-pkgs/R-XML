...
Version  : 3.99.0.9
Release  : 100
URL      : https://cran.r-project.org/src/contrib/XML_3.99-0.9.tar.gz
Source0  : https://cran.r-project.org/src/contrib/XML_3.99-0.9.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645722193
