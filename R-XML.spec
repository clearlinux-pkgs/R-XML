...
Version  : 3.98.1.18
Release  : 60
URL      : https://cran.r-project.org/src/contrib/XML_3.98-1.18.tar.gz
Source0  : https://cran.r-project.org/src/contrib/XML_3.98-1.18.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1551719274
