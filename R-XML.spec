...
Version  : 3.98.1.15
Release  : 55
URL      : https://cran.r-project.org/src/contrib/XML_3.98-1.15.tar.gz
Source0  : https://cran.r-project.org/src/contrib/XML_3.98-1.15.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1533954440
