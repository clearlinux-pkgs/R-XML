...
Version  : 3.99.0.6
Release  : 84
URL      : https://cran.r-project.org/src/contrib/XML_3.99-0.6.tar.gz
Source0  : https://cran.r-project.org/src/contrib/XML_3.99-0.6.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615910343
